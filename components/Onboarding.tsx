    ...
    <div className="w-full max-w-md mx-auto">
      ...
      <div className="flex justify-center gap-2 mb-6">
        {Array.from({ length: totalSteps }).map((_, idx) => (
          <div 
            key={idx} 
            className={`h-1.5 rounded-full transition-all duration-300 ${idx + 1 === currentStep ? 'w-8 bg-purple-500 shadow-[0_0_10px_#a855f7]' : 'w-2 bg-white/10'}`} 
          />
        ))}
      </div>

      <GlassCard className="p-0 overflow-hidden min-h-[420px] flex flex-col relative">
        {/* Step Content Area */}
        ...
        <div className="p-6 border-t border-white/5 flex justify-between items-center bg-black/20">
          ...
          <Button onClick={goNext} className="shadow-purple-900/40">
        ...
        >
          ...
          <Step>
            <div className="flex flex-col items-center text-center h-full justify-center space-y-6">
              <div className="w-20 h-20 bg-gradient-to-br from-purple-800 to-black rounded-full flex items-center justify-center shadow-lg shadow-purple-900/30">
                <Scissors className="text-white w-10 h-10" />
              </div>
              <div>
                <h2 className="text-2xl font-bold text-white mb-3 tracking-tight">
                  Bem-vindo à Experiência DarkVeil
                </h2>
          ...
          <Step>
            <div className="flex flex-col h-full space-y-6">
              <div className="text-center">
                <h2 className="text-2xl font-bold text-white mb-2">Agendamento Inteligente</h2>
              ...
              <div className="relative w-full h-40 rounded-xl overflow-hidden border border-white/10 group">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm">
                  <Calendar className="w-12 h-12 text-purple-400 drop-shadow-[0_0_10px_rgba(168,85,247,0.5)]" />
                </div>
              </div>

              <p className="text-gray-400 text-center text-sm leading-relaxed px-2">
                Escolha seu serviço, barbeiro de preferência e receba a confirmação e lembretes direto no seu <span className="text-green-400 font-semibold">WhatsApp</span>.
              </p>
            </div>
          </Step>
          ...
          <Step>
             <div className="flex flex-col h-full justify-center space-y-6">
              <div className="text-center">
                ...
                <h2 className="text-2xl font-bold text-white mb-2">Perfil & Visagismo</h2>
                <p className="text-gray-400 text-sm">Ajude-nos a personalizar sua experiência.</p>
              </div>
              ...
              <div className="space-y-4">
                <Input 
                  ...
                  className="bg-black/50 border-purple-900/30 focus:border-purple-500"
                />
          ...
          <Step>
            <div className="flex flex-col items-center text-center h-full justify-center space-y-6">
              <motion.div 
                ...
                className="w-24 h-24 bg-green-500/10 border border-green-500/30 rounded-full flex items-center justify-center mb-2"
              >
